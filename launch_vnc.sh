...
# Nhớ gõ YES
# Dùng / Use
# sudo apt update && sudo apt install curl wget build-essential cmake make firefox kitty fluxbox openbox tigervnc-standalone-server git tint2 -y
# hoặc / or
# apt update && apt install sudo curl wget build-essential cmake make firefox-esr kitty fluxbox openbox tigervnc-standalone-server git tint2 -y
# Chrome install
